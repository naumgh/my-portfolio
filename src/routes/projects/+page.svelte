...
<ProjectCard
    ...
    description="Analyzed and visualized medical data to explore relationships between health metrics and cardiovascular disease using categorical plots and heatmaps."
    highlights={[
